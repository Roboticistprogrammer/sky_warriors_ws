...
echo "  - Drone 0 (port 14540) at LZ (0, 0)"
echo "  - Drone 1 (port 14541) at LZ (4, 3)"
echo "  - Drone 2 (port 14542) at LZ (8, 0)"
echo ""
...
echo "QGroundControl ports: 14540, 14541, 14542"
echo ""
echo "To run failsafe tests:"
