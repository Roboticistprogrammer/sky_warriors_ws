...
namespace Neighborhood {
    ...
    protected:
         ...
         */
        virtual void process_neighbor_position([[maybe_unused]] const std::size_t drone_idx,
                                               [[maybe_unused]] const std::size_t neighbor_idx,
                                               [[maybe_unused]] const VehicleLocalPosition &position,
                                               [[maybe_unused]] VehicleLocalPosition neighbor_position,
                                               [[maybe_unused]] Neighbors &neighborhood) {
         ...
         */
        virtual void process_neighborhood([[maybe_unused]] const std::size_t drone_idx,
                          [[maybe_unused]] Neighbors &neighborhood) {};
         ...
         * @param neighborhood The neighborhood to be enriched.
         */
        virtual void enrich_neighborhood([[maybe_unused]] Neighbors &neighborhood) {};
